...
//        public AuthService(IConfiguration configuration, IUserRepository userRepository, IUserTokenRepository userTokenRepository)
//        {
...
//            // ✅ если refreshToken ещё активен и до истечения > 1 час, просто обновим access-токен
...
//                    RefreshToken = refreshToken, // старый остаётся
...
//            // 🔁 refresh-токен уже "старый" → сгенерируем новый

            ...
            >
              {/* <InputLabel>Вибір</InputLabel>
                <Select
                  label="Вибір"
                  value={
                    savedAnswer && savedAnswer[index] !== undefined
                      ? savedAnswer[index] === -1
                        ? -1 // выбран X1
                        : savedAnswer[index] // выбран конкретный id
...
//   const advancedRightLabels = generateLabels(
//     leftItems.length,
...
// const handleChange = (leftIndex: number, selected: string | number) => {
//   const updated = savedAnswer ? [...savedAnswer] : Array(leftItems.length).fill(0);

//   let value: number;

//   // 1. Попытка получить валидный ID
//   const numericValue = Number(selected);
//   if (!isNaN(numericValue) && numericValue > 0) {
//     value = numericValue;
//   }
//   // 2. Нет соответствия — X…
//   else if (typeof selected === "string" && selected.startsWith("X")) {
//     value = -1;
//   }
//   // 3. Все остальные случаи — 0 (не выбрано)
//   else {
//     value = 0;
//   }

...
//                 Главная
//               </Button>
//               <Button component={RouterLink} to="/topics" color="inherit">
//                 Темы
//               </Button>
...
//           {!isMobile && (
//             <Box sx={{ display: "flex", gap: 3 }}>
//               <Button component={RouterLink} to="/" color="inherit" sx={{ fontSize: "1.2rem" }}>
//                 Головна
//               </Button>
//               <Button component={RouterLink} to="/test-auth" color="inherit" sx={{ fontSize: "1.2rem" }}>
//                 Теми
//               </Button>
//               <TestMenu />
//               <Button component={RouterLink} to="/about" color="inherit" sx={{ fontSize: "1.2rem" }}>
//                 Про платформу
//               </Button>
//             </Box>
//           )}
...
//                 <AppRegistrationIcon sx={{ fontSize: "1.5vw" }} />
//               </IconButton>
//             </Tooltip>
//           </Box>
...
//   Avatar
// } from "@mui/material";
// import { LightMode, DarkMode, Login, Logout } from "@mui/icons-material";
// import AppRegistrationIcon from "@mui/icons-material/AppRegistration";
// import { Link as RouterLink } from "react-router-dom";
// import { TestMenu } from "../TestMenu";

...
//   images: string[];
//   description: string;
//   detailedDescription?: string; // Добавляем проп для подробного описания
...
//         overflow: "hidden",
//         cursor: "pointer", // Курсор указатель на всей карточке
//         ...sx
//       }}>
...
//               zIndex: 2,
//               pointerEvents: "none" // Чтобы клик работал на контейнере
//             }}
//           />
//           <Box
//             component="img"
...
//             cursor: "pointer",
//             "&:hover": {
//               textDecoration: "underline" // Эффект при наведении
//             }
//           }}
//         >
//           {title}

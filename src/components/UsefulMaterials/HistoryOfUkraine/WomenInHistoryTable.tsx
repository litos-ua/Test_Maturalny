...
//               <TableCell sx={{ fontWeight: 700, width: 120, textAlign: 'center' }}>Фото</TableCell>  {/* НОВА КОЛОНКА */}
//               <TableCell sx={{ fontWeight: 700, minWidth: 200 }}>Персоналія (роки життя)</TableCell>  {/* ОБ'ЄДНАНО */}
